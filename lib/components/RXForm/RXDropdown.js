...
var RXDropdown = function (_RXSelectionElement) {
    ...
    _createClass(RXDropdown, [{
        ...
        value: function renderButton() {
            ...
            var dropDownButtonClassName = "drop-down-button" + (this.props.disabled ? " disabled" : " enabled");
        ...
        value: function renderElement() {
            ...
            var _props3 = this.props,
                ...
                _props3$listBodyClass = _props3.listBodyClassName,
                listBodyClassName = _props3$listBodyClass === undefined ? 'drop-down-body' : _props3$listBodyClass,
                useButtonWidth = _props3.useButtonWidth,
                idAttribute = _props3.idAttribute;
