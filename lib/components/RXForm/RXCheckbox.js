...
var RXCheckbox = function (_RXFormElement) {
    ...
    _createClass(RXCheckbox, [{
        ...
        value: function getFormClasses() {
            var classArray = _get(RXCheckbox.prototype.__proto__ || Object.getPrototypeOf(RXCheckbox.prototype), 'getFormClasses', this).call(this);
            if (this.state.value) {
        ...
        value: function renderElementWithWrapper() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'label',
                    { className: 'element-label form-check-label' },
                    this.renderElement(),
                    this.props.label
                ),
