...
var RXSelectionElement = function (_RXFormElement) {
    ...
    _createClass(RXSelectionElement, [{
        ...
        key: 'stringifySelection',
        value: function stringifySelection(selection) {
            if (this.multiSelect) {
        ...
        value: function readInputValue() {
            var valueRead = this.selectionManager.getSelected();
...
_RXFormElement3.default.defaultProps = _extends({}, _RXFormElement3.default.defaultProps, {
    type: 'text',
    placeholder: 'Select',
    label: 'Select',
    options: []
