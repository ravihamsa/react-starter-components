...
var RXSelectionItem = exports.RXSelectionItem = function (_Component) {
    ...
    _createClass(RXSelectionItem, [{
        ...
        value: function render() {
            ...
            var idAttribute = this.props.idAttribute;
    ...
    _createClass(RXSelectionElement, [{
        ...
        value: function UNSAFE_componentWillReceiveProps(newProps) {
            ...
            if (newOptions && selected) {
                if (newOptions.length && !_utils._.isEqual(newOptions, this.props.options)) {
                    if (this.multiSelect) {
                        _utils._.each(selected, function (item) {
                            var selectedOption = newOptions.find(function (optionItem) {
                                return optionItem[idAttribute] === item[idAttribute];
                            });
                            if (!selectedOption) {
                        ...
                        var selectedOption = newOptions.find(function (optionItem) {
                            return optionItem[idAttribute] === selected[idAttribute];
                        });
                        if (!selectedOption) {
        ...
        value: function getFormattedSelection() {
            ...
            if (this.multiSelect) {
                return _utils._.map(selection, idAttribute).join(',');
            } else {
        ...
        value: function renderElement() {
            ...
            var _props6 = this.props,
                _props6$ListItem = _props6.ListItem,
                ListItem = _props6$ListItem === undefined ? RXSelectionItem : _props6$ListItem,
                idAttribute = _props6.idAttribute;
