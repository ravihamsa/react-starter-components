...
var RXDatePicker = function (_RXFormElement) {
    ...
    _createClass(RXDatePicker, [{
        ...
        value: function getRestProps() {
            var props = _.omit(this.state, 'showLabel', 'debounceTime', 'options', 'helperText', 'active', 'error', 'validations', 'activeRules', 'valid', 'serverValidation', '__shadowValue', 'register', 'clear', 'exposeName', 'exposeSelection', 'serverValid', 'serverError', 'displayDate', 'selectedDate');
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        InlineBody,
                        null,
                        React.createElement(_Month2.default, { onDateSelect: this.onChange.bind(this), selectedDate: restProps.value,
