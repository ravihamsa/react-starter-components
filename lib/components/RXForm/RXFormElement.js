            ...
            if (this.props.serverValidation) {
                (function () {
                    ...
                    var setError$ = validateRequest$.flatMap(function (val) {
                        return _rxjs2.default.Observable.fromPromise(_dataLoader2.default.getRequestDef(serverValidation.requestId, serverValidation.getParams.call({ value: val.value }, _this4.context.elementValueIndex)));
