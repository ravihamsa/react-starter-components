...
var propsList = ['active', 'error', 'disabled', 'valid', '__shadowValue', 'value', 'type'];
...
var RXFormElement = function (_Component) {
    ...
    _createClass(RXFormElement, [{
        ...
        value: function getRestProps() {
            var props = _lodash2.default.omit(this.state, 'showLabel', 'debounceTime', 'options', 'helperText', 'active', 'error', 'validations', 'activeRules', 'valid', 'serverValidation', '__shadowValue', 'register');
