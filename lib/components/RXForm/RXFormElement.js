...
RXFormElement.contextTypes = {
    ...
    hasController: _react.PropTypes.bool.isRequired
};

RXFormElement.propTypes = {
    type: _react.PropTypes.string.isRequired,
    name: _react.PropTypes.string.isRequired,
    helperText: _react.PropTypes.string,
    getPropValue: _react.PropTypes.func.isRequired,
    ...
    propRules: _react.PropTypes.array,
