...
var defaultPropReturnFunction = _lodash2.default.identity;
...
var RXFormElement = function (_Component) {
    ...
    function RXFormElement(props) {
        ...
        _this.unmount$ = new _rxjs2.default.Subject();
    ...
    _createClass(RXFormElement, [{
        ...
        value: function addPropListeners() {
            ...
            var groupedPropRules = _lodash2.default.groupBy(propRules, function (e) {
                return e.prop;
            });
            ...
            // .do(value=>console.log(value, 'activeCheck'))
            .takeUntil(this.unmount$).subscribe(function (value) {
                _lodash2.default.each(groupedPropRules, function (rules, prop) {
                    var propValue = _lodash2.default.reduce(rules, function (memo, rule) {
        ...
        value: function getRestProps() {
            var props = _lodash2.default.omit(this.state, 'showLabel', 'debounceTime', 'options', 'helperText', 'active', 'error', 'validations', 'activeRules', 'valid', 'serverValidation', '__shadowValue', 'register', 'clear', 'exposeName', 'exposeSelection', 'serverValid', 'serverError');
