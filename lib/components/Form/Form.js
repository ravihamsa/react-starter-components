...
var Form = function (_Component) {
    ...
    _createClass(Form, [{
        ...
        value: function isFormValid() {
            ...
            var hasErrors = _utils._.values(errorStore.getAll()).filter(function (item) {
        ...
        value: function setValues(map, skipValidate) {
            ...
            _utils._.each(_utils._.keys(map), function (elementName) {
...
var ElementGroup = exports.ElementGroup = function (_Form) {
    _inherits(ElementGroup, _Form);
