...
var Form = function (_Component) {
    ...
    _createClass(Form, [{
        ...
        key: 'setValues',
        value: function setValues(map) {
            var _this2 = this;

            _lodash2.default.each(_lodash2.default.keys(map), function (elementName) {
                return _this2.setValue(elementName, map[elementName]);
            });
        }
    }, {
        key: 'setValue',
        value: function setValue(elementName, value) {
