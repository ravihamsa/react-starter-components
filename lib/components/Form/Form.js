    ...
    _createClass(Form, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                'form',
                { onSubmit: this.props.onSubmitHandler.bind(this.props.valueStore) },
                this.props.children
            );
        }
    }, {
        ...
        value: function getChildContext() {
            ...
            var store = this.props.valueStore || new SimpleModel();
            var detailStore = this.props.valueDetailStore || new SimpleModel();
