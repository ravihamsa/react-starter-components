...
var HiddenInput = function (_FormElement) {
    _inherits(HiddenInput, _FormElement);
    ...
    _createClass(HiddenInput, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("input", { type: "hidden", className: "form-control", name: this.props.name,
...
HiddenInput.defaultProps = _extends({}, _FormElement3.default.defaultProps, {
    type: 'hidden'
});