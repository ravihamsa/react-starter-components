...
var SelectionFormElement = function (_FormElement) {
    ...
    _createClass(SelectionFormElement, [{
        ...
        value: function UNSAFE_componentWillMount() {
            _get(SelectionFormElement.prototype.__proto__ || Object.getPrototypeOf(SelectionFormElement.prototype), 'UNSAFE_componentWillMount', this).call(this);
        ...
        value: function onChange(selection) {
            ...
            if (!this.selectionManager.isEmpty()) {
                if (this.multiSelect) {
                    valueToSet = _utils._.map(selection, 'id');
                } else {
        ...
        value: function applyValue(value) {
            ...
            if (this.multiSelect) {
                value = value || [];
                _utils._.each(value, function (valueId) {
