                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                this.props.showSearch ? _react2.default.createElement('input', { type: 'text', autoFocus: true, defaultValue: this.state.query, ref: 'searchBox', onChange: this.onKeyPressHandler, className: 'drop-down-input', placeholder: placeholder }) : null,
                                _react2.default.createElement(
                                    'div',
                                    { onClick: this.clickHandler.bind(this) },
                                    _react2.default.createElement(_List2.default, { ListItem: ListItem, className: this.multiSelect ? 'multi-select list' : 'single-select list', items: filteredOptions, selection: this.state.selection,
