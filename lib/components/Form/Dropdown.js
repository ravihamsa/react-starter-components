...
var Dropdown = function (_SelectionFormElement) {
    ...
    function Dropdown() {
        ...
        _this.onKeyPressHandler = _utils._.debounce(_this._onKeyPressHandler.bind(_this), 300);
        _this.state.query = '';
        return _this;
    }
    ...
    _createClass(Dropdown, [{
        ...
        value: function render() {
            ...
            var filteredOptions = _utils._.filter(options, function (item) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { ref: function ref(inlinePopup) {
                                return _this2.ref_inlinePopup = inlinePopup;
                            ...
                            _react2.default.createElement(
                                ...
                                this.props.showSearch ? _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('input', { type: 'text', autoFocus: true, defaultValue: this.state.query, ref: function ref(searchBox) {
                                            return _this2.ref_searchBox = searchBox;
                                        }, onChange: this.onKeyPressHandler, className: 'drop-down-input', placeholder: placeholder }),
                                    ' '
                                ) : null,
                                _react2.default.createElement(
                                    'div',
