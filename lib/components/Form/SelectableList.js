...
var SelectableList = function (_FormElement) {
    _inherits(SelectableList, _FormElement);

    function SelectableList() {
        _classCallCheck(this, SelectableList);

        var _this2 = _possibleConstructorReturn(this, (SelectableList.__proto__ || Object.getPrototypeOf(SelectableList)).apply(this, arguments));
    ...
    _createClass(SelectableList, [{
        ...
        value: function componentWillMount() {
            ...
            this.unsubscribeSelection = this.selectionManager.on('change', function (selection) {
                _this3.setState({ selection: selection });
                if (_this3.multiSelect) {
                    _this3.setValue(_.map(selection, 'id'));
                } else {
                    _this3.setValue(selection.id);
                }
            });
