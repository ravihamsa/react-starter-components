...
exports.default = {
    ...
    Collector: _SimpleForm.Collector,
    SimpleElement: _SimpleForm.SimpleElement,
    CollectorChild: _SimpleForm.CollectorChild,
    ...
    SimpleDateRangePicker: _SimpleForm.SimpleDateRangePicker,
    SimpleTextArea: _SimpleForm.SimpleTextArea
}; /**
