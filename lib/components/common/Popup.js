    ...
    _createClass(Popup, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                _extends({ styles: popupStyles }, this.props, { className: className }),
...
var PopupBody = function (_Component3) {
    ...
    _createClass(PopupBody, [{
        ...
        value: function render() {
            ...
            var className = this.props.className || 'default';

            if (this.props.isOpen) {
                return _react2.default.createElement(
                    'div',
                    { style: popupContainerStyles, className: "popup-container " + className },
                    _react2.default.createElement('div', { style: maskStyles, onClick: this.maskClick.bind(this), className: "popup-mask " + className }),
                    _react2.default.createElement(
                        'div',
                        {
                            style: bodyStyles, className: "popup-body " + className },
                        ' ',
