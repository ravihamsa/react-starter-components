...
var PopupBody = function (_Component3) {
    ...
    _createClass(PopupBody, [{
        ...
        value: function updatePortalElementPosition() {
            ...
            var style = { position: 'absolute', left: 0, top: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 99 };
            for (var i in style) {
                p.style[i] = style[i];
            }
        }
        ...
        value: function hidePortalElement() {
            ...
            var style = { position: 'absolute', left: 0, top: 0, width: 0, height: 0, backgroundColor: 'rgba(0,0,0,0)', zIndex: 99 };
            for (var i in style) {
                p.style[i] = style[i];
            }
        }
        ...
        value: function componentDidUpdate() {
            ...
            if (this.props.isOpen) {
                ...
                ReactDOM.render(_react2.default.createElement('div', { className: 'dummy-container' }), this.portalElement);
            }
        }
    }, {
        key: 'render',
