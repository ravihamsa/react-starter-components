...
_rxutils.bodyClick$.filter(function () {
...
if (typeof document !== 'undefined') {
    var _inlineModalRoot = document.createElement('div');
    _inlineModalRoot.className = 'modal-root';
    for (var i in rootStyle) {
        _inlineModalRoot.style[i] = rootStyle[i];
    }
    document.body.appendChild(_inlineModalRoot);
}
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _utils2.default.cloneChildren(this.props.children, { closePopup: this.props.closePopup })
                )
            );
        }
    }]);
