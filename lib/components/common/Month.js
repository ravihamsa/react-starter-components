...
var Day = function (_Component) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            var booleanClasses = _utils._.map(['today', 'selected', 'selectable'], function (className) {
...
var Month = function (_Component3) {
    ...
    function Month(props) {
        ...
        _this3.DATE_FORMAT = _utils2.default.getStarterConfig('dateFormat');
        _this3.state = {
            displayDate: props.displayDate || today.format(_this3.DATE_FORMAT),
            selectedDate: props.selectedDate || null,
            minDate: props.minDate || today.format(_this3.DATE_FORMAT),
    ...
    _createClass(Month, [{
        ...
        value: function bumpMonth(diff) {
            var displayDate = (0, _moment2.default)(this.state.displayDate, this.DATE_FORMAT);
            this.setState({
        ...
        value: function onDateClick(dateObject) {
            var DATE_FORMAT = _utils2.default.getStarterConfig('dateFormat');
            var dateValue = dateObject.dateObject.format(this.DATE_FORMAT);
            this.setState({
        ...
        value: function render() {
            var displayDate = (0, _moment2.default)(this.state.displayDate, this.DATE_FORMAT);
            var selectedDate = (0, _moment2.default)(this.state.selectedDate, this.DATE_FORMAT);
            var minDate = (0, _moment2.default)(this.state.minDate, this.DATE_FORMAT);
            var maxDate = (0, _moment2.default)(this.state.maxDate, this.DATE_FORMAT);
            var today = (0, _moment2.default)();
