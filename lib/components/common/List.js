...
var SelectableItem = exports.SelectableItem = function (_ListItem) {
    ...
    function SelectableItem() {
        ...
        var itemData = _this5$props.itemData;
        var selectionManager = _this5$props.selectionManager;
    ...
    _createClass(SelectableItem, [{
        ...
        value: function updateSelectionState() {
            ...
            var itemData = _props.itemData;
            var selectionManager = _props.selectionManager;
        ...
        value: function selectItem(event) {
            ...
            var itemData = _props2.itemData;
            var selectionManager = _props2.selectionManager;
