...
var ListItem = exports.ListItem = function (_Component) {
    ...
    _createClass(ListItem, [{
        ...
        value: function getTagProps() {
            return _utils._.pick(this.props, 'className', 'style');
        }
    }]);
...
var LayoutList = exports.LayoutList = function (_Component2) {
    ...
    _createClass(LayoutList, [{
        ...
        value: function render() {
            ...
            var otherProps = _utils._.omit(this.props, 'className', 'style', 'tagName', 'noDataMessage', 'ListItem', 'itemClassName', 'itemTagName');
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            var listItems = itemArray.map(function (item, index) {
                var ListItemClass = _this5.getItemClass(item);
                return _react2.default.createElement(ListItemClass, _extends({ key: item.id, itemIndex: index, itemData: item }, otherProps));
            });
...
var SelectableItem = exports.SelectableItem = function (_ListItem) {
    ...
    function SelectableItem() {
        ...
        var _this6 = _possibleConstructorReturn(this, (SelectableItem.__proto__ || Object.getPrototypeOf(SelectableItem)).apply(this, arguments));

        var _this6$props = _this6.props,
            itemData = _this6$props.itemData,
            selectionManager = _this6$props.selectionManager;
    ...
    _createClass(SelectableList, [{
        ...
        value: function componentDidMount() {
            ...
            if (selectionManager) {
                this.unsubscribeSelection = selectionManager.on('change', function (selection, prevSelection) {
                    var fullList = _utils._.flatten([selection, prevSelection]);
                    _utils._.each(fullList, function (item) {
                        if (item) {
        ...
        value: function render() {
            ...
            var listItems = itemArray.map(function (item, index) {
                ...
                return _react2.default.createElement(ListItemClass, _extends({ key: item.id, ref: function ref(element) {
                        return _this8.ref_[item.id] = element;
                    }, itemIndex: index, itemData: item }, otherProps));
            });
