    ...
    _createClass(InlinePopup, [{
        ...
        value: function openPopup() {
            ...
            clickSubscription = _rxutils.bodyClick$.filter(function (event) {
                ...
                var bodyRoot = _this2.refs.inlineBody.portalElement;
        ...
        value: function render() {
            ...
            var domProps = _.pick(this.props, 'className');
    ...
    _createClass(InlineBody, [{
        ...
        value: function componentDidUpdate() {
            if (this.props.isOpen) {
                ...
                var style = { position: 'absolute', overflow: 'auto', maxHeight: 200 };
                style.left = bounds.left;
                style.top = bounds.top;
                style.width = bounds.width;
                ReactDOM.render(_react2.default.createElement(
                    'div',
                    { className: 'inline-popup-body',
                        style: style },
