...
var InlinePopup = function (_Component) {
    ...
    _createClass(InlinePopup, [{
        ...
        value: function isClickedOutside(event, popup) {
            ...
            var bodyRoot = popup.ref_inlineBody.portalElement;
        ...
        value: function getButtonBounds() {
            return _reactDom2.default.findDOMNode(this.ref_inlineButton).getBoundingClientRect();
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var refMap = [function (inlineButton) {
                return _this3.ref_inlineButton = inlineButton;
            }, function (inlineBody) {
                return _this3.ref_inlineBody = inlineBody;
            }];

            return _react2.default.createElement(
                'div',
                _extends({ style: popupStyles, ref: function ref(rootEl) {
                        return _this3.ref_rootEl = rootEl;
                    } }, domProps),
...
var InlineBody = function (_Component3) {
    ...
    _createClass(InlineBody, [{
        ...
        value: function updatePortalElementPosition() {
            ...
            var refEl = _reactDom2.default.findDOMNode(this);
        ...
        value: function componentDidUpdate() {
            ...
            if (this.props.isOpen) {
                ...
                _reactDom2.default.render(_react2.default.createElement('div', null), this.portalElement);
            }
        }
    }]);
