...
var ActionLink = function (_Component) {
    ...
    _createClass(ActionLink, [{
        ...
        value: function onClick(event) {
            ...
            this.props.controller.onAction(this.props.action, _lodash2.default.omit(this.props, ['action', 'controller', 'children']));
        }
    }, {
        key: 'render',
        value: function render() {
            var href = this.props.href || '#';
            var ContainerTag = this.props.tagName || 'a';
