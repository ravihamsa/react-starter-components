...
var Collector = exports.Collector = function (_Component) {
    ...
    _createClass(Collector, [{
        key: 'afterUpdate',
        value: function afterUpdate(key, value, isDirty, prevFullObject) {
            ...
            if (onValueChange) {
                onValueChange(_defineProperty({}, key, value), fullObject, prevFullObject, isDirty);
            }
        }
    }, {
        key: 'updateValue',
        value: function updateValue(key, value) {
            var prevFullObject = this.model.toJSON();
