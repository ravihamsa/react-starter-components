...
var SimpleTextArea = function (_SimpleElement) {
    _inherits(SimpleTextArea, _SimpleElement);

    function SimpleTextArea() {
        _classCallCheck(this, SimpleTextArea);

        return _possibleConstructorReturn(this, (SimpleTextArea.__proto__ || Object.getPrototypeOf(SimpleTextArea)).apply(this, arguments));
    }
...
SimpleTextArea.defaultProps = _extends({}, _SimpleElement3.default.defaultProps, {
    type: 'textArea'
});