    ...
    _createClass(SimpleSelectionElement, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_List2.default, { items: this.getFilteredOptions(), selectionManager: this.selectionManager, selection: selected, ListItem: ListItem })
            );
        }
    }]);
