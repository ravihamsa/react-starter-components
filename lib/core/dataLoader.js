...
var DataLoader = function () {
    ...
    _createClass(DataLoader, [{
        ...
        value: function addResource(requestId, config) {
            config = _utils._.defaults(config, { cache: 'session', queue: 'queue', method: 'get' });
        ...
        value: function getRequestDef(requestId, payload, onProgress) {
            ...
            switch (config.type) {
                ...
                case 'url':
                    ...
                    var fetchPromise = this._getFetchPromise(config, payload, requestId, requestHash, onProgress);
                    if (queue !== 'none') {
