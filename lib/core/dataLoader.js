...
var DataLoader = function () {
    function DataLoader() {
        ...
        this._dataCache = {};
        this._middlewares = {};
        this._beforeRequestHandler = _utils._.identity;
    ...
    _createClass(DataLoader, [{
        ...
        key: 'setBeforeRequestHandler',
        value: function setBeforeRequestHandler(fn) {
        ...
        value: function _getFetchPromise(config, payload, payLoadToServer, requestId, requestHash, onProgress) {
            ...
            return new _bluebird2.default(function (resolve, reject) {
                ...
                if (method === 'upload') {
                    ...
                    fetchPromise = (0, _isomorphicFetch2.default)(url, requestConfig);
                }
