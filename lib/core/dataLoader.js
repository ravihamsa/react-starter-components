...
var _fetchFetchClient = require('./fetch/fetch.client');

var _fetchFetchClient2 = _interopRequireDefault(_fetchFetchClient);
    ...
    _createClass(DataLoader, [{
        ...
        value: function getRequestDef(requestId, payload) {
            ...
            return new _bluebird2['default'](function (resolve, reject) {
                ...
                var fetchPromise = (0, _fetchFetchClient2['default'])(requestUrl, requestConfig);
