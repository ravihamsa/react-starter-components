...
var DataLoader = function () {
    ...
    _createClass(DataLoader, [{
        ...
        value: function _getXHRPromise(url) {
            ...
            return new _bluebird2.default(function (res, rej) {
                ...
                for (var k in opts.headers || {}) {
                    ...
                    return res({ ok: true, json: function json() {
        ...
        value: function _getFetchPromise(config, payload, requestId, requestHash, onProgress) {
            var _this = this;
            ...
            var _ret = function () {
                switch (config.type) {
                    ...
                    case 'url':
                        ...
                        var cachedDataPromise = _this2._getCachedDataPromise(requestHash);
                        if (cachedDataPromise) {
                            return {
                                v: cachedDataPromise
                            };
                        }
                        var queuePromise = _this2._getQueuedPromise(requestHash);
                        if (queuePromise) {
                            return {
                                v: queuePromise
                            };
                        ...
                        var fetchPromise = _this2._getFetchPromise(config, payload, requestId, requestHash, onProgress);
                        if (queue !== 'none') {
