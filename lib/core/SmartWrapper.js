...
exports.ControllerWrapper = exports.NoLoadingSmartWrapper = undefined;
    ...
    _createClass(SmartWrapper, [{
        ...
        value: function addRequestIfValid(propName, requestId, filteredProps, storeConfig) {
            ...
            if (isRequestValid) {
                ...
                this.addRequestWithController({ propName: propName, requestId: requestId, params: params, storeConfig: storeConfig });
            } else {
                ...
                def.done(function (data) {
                    return _this2._updateDataIndex(propName, data);
                });
        ...
        value: function renderChildren() {
            return cloneChildren(this.props.children, _extends({}, this.dataIndex, { addRequest: this.addRequest.bind(this) }));
        }
    }, {
        key: 'render',
...
var ControllerWrapper = exports.ControllerWrapper = function (_SmartWrapper2) {
    _inherits(ControllerWrapper, _SmartWrapper2);
