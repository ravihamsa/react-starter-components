...
exports.Rx = exports.createEventStream = exports.windowResize$ = exports.escapePress$ = exports.bodyKeyPress$ = exports.bodyKeyUp$ = exports.bodyClick$ = undefined;
...
var bodyKeyPress$ = exports.bodyKeyPress$ = _Observable.Observable.of(true);
...
if (global.document) {
    ...
    exports.bodyKeyPress$ = bodyKeyPress$ = _Observable.Observable.fromEvent(document, 'keypress');
