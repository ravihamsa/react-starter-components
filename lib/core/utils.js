...
var getDomProps = function getDomProps(props) {
    var filteredProps = {};
...
exports.default = {
    identity: identity, cloneChildren: cloneChildren, connectToStore: connectToStore, getUniqueId: getUniqueId, getDomProps: getDomProps
};