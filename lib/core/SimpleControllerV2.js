...
var SimpleControllerV2 = function (_SimpleEmitter) {
    ...
    function SimpleControllerV2(config) {
        ...
        ['singleSelect', 'multiSelect', 'clearSelection', 'set', 'setError', 'update', 'clear', 'setList', 'addToList', 'removeFromList', 'updateInList', 'resetInList'].forEach(function (methodName) {
