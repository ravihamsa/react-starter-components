    ...
    addServerValidationListeners() {
        ...
        if (this.props.serverValidation) {
            ...
            let setError$ = validateRequest$.flatMap((val) => {
                return Rx.Observable.fromPromise(dataLoader.getRequestDef(serverValidation.requestId, serverValidation.getParams(val.value, this.context.elementValueIndex)))
